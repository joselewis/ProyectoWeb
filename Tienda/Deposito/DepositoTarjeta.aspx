    ...
    <center>
        ...
        <br />
            ...
            <div class="input-group mb-3">
                <span>
                  <asp:Label runat="server" ID="LblNumeroTarjeta" Text="Número tarjeta"></asp:Label>
            ...
            <div class="input-group mb-3">
              <span>
                  <asp:Label runat="server" ID="LblCantidadDepositada" Text="Cantidad a depositada"></asp:Label>
