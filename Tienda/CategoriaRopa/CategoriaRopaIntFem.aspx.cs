...
{
    public partial class CategoriaRopaIntFem : System.Web.UI.Page
    {
        ...
        void CargarCategoriaRopa()
        {
            ...
            cmd.CommandText = "SELECT * FROM PRODUCTO_ROPA INNER JOIN CLASIFICAR_ROPA ON PRODUCTO_ROPA.CODIGO_PRODUCTO = CLASIFICAR_ROPA.CODIGO_PRODUCTO WHERE CATEGORIA_PRENDA = 'Ropa interior femenina'";
            cmd.ExecuteNonQuery();
        ...
        void ValidarCargarRopa()
        {
            try
            {
                ...
                {
                    var ListadoProductos = ContextoDB.CLASIFICAR_ROPA.Where(s => s.CATEGORIA_PRENDA == "Ropa interior femenina").ToList();
                    ...
                    else
                    {
                        ...
                        LblNoHayNada.Text = "No hay ropa interior femenina disponibles";
                    }
                }
            }
            catch (Exception ex)
