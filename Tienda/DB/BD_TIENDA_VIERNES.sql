...
CREATE TABLE DINERO_PAGO
(
	ID_DINERO INT IDENTITY PRIMARY KEY NOT NULL,
	CANTIDAD_DISPONIBLE INT NOT NULL,
	NUMERO_TARJETA BIGINT,
	CONSTRAINT FK_TARJETA_DINERO FOREIGN KEY (NUMERO_TARJETA) REFERENCES METODO_PAGO(NUMERO_TARJETA)
)
...
(
	...
	CONSTRAINT FK_ORDEN_USUARIO FOREIGN KEY (CORREO_ELECTRONICO) REFERENCES USUARIOS(CORREO_ELECTRONICO),
	CONSTRAINT FK_ORDEN_METODOPAGO FOREIGN KEY (NUMERO_TARJETA) REFERENCES METODO_PAGO(NUMERO_TARJETA),
	CONSTRAINT FK_ORDEN_PRODUCTOS FOREIGN KEY (CODIGO_PRODUCTO) REFERENCES PRODUCTO_ROPA(CODIGO_PRODUCTO),
	CONSTRAINT FK_ORDEN_CARRITO FOREIGN KEY (ID_CARRITO) REFERENCES CARRITO(ID_CARRITO)
)
...
FROM PRODUCTO_ROPA
INNER JOIN CARRITO ON CARRITO.CODIGO_PRODUCTO = PRODUCTO_ROPA.CODIGO_PRODUCTO
INNER JOIN USUARIOS ON USUARIOS.CORREO_ELECTRONICO = CARRITO.CORREO_ELECTRONICO
INNER JOIN ORDEN_COMPRA ON USUARIOS.CORREO_ELECTRONICO = ORDEN_COMPRA.CORREO_ELECTRONICO WHERE ORDEN_COMPRA.CORREO_ELECTRONICO = 'joselewis@gmail.com'

SELECT CODIGO_PRODUCTO, ID_CARRITO, CORREO_ELECTRONICO, ID_ORDEN_COMPRA, NUMERO_TARJETA 
FROM ORDEN_COMPRA
INNER JOIN CARRITO ON CARRITO.ID_CARRITO = ORDEN_COMPRA.CODIGO_PRODUCTO
INNER JOIN METODO_PAGO ON METODO_PAGO.NUMERO_TARJETA = ORDEN_COMPRA.NUMERO_TARJETA 
INNER JOIN USUARIOS ON USUARIOS.CORREO_ELECTRONICO = ORDEN_COMPRA.CORREO_ELECTRONICO WHERE USUARIOS.CORREO_ELECTRONICO = 'joselewis@gmail.com'
